...
/**
 * Edit card for Form = HealthSport. Same field set as History:
 * Form, Название, Расшифровка, Комментарий; StartDate hidden but equals creation date.
 */
public class HealthSportActivity extends BaseCalPlanEditActivity {

    @Override
    protected String getFormType() { return "HealthSport"; }
    @Override
