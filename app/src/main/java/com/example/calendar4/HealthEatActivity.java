...
/**
 * Edit card for Form = HealthEat. Same field set as History:
 * Form, Название, Расшифровка, Комментарий; StartDate hidden but equals creation date.
 */
public class HealthEatActivity extends BaseCalPlanEditActivity {

    @Override
    protected String getFormType() { return "HealthEat"; }
    @Override
